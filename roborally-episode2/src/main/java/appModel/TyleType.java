...
public enum TyleType {
    ...
    LaserV("src/test/resources/images/LaserV.png"),
    LaserH("src/test/resources/images/LaserH.png"),
    Floor("src/test/resources/images/floor.png"),
    Health("src/test/resources/images/health.png"),
    ConveyorN("src/test/resources/images/ConveyorN.png"),
    ConveyorS("src/test/resources/images/ConveyorS.png"),
    ConveyorW("src/test/resources/images/ConveyorW.png"),
    ConveyorE("src/test/resources/images/ConveyorE.png"),
